export default function HeadingContainer({ children }) {
    return (
        <div className="relative bg-teal-50">
            ...
            <div className="absolute bottom-0 left-0 grid h-[60%] max-h-[100px] w-[30%] max-w-[300px] grid-rows-3">
            ...
            <div className="absolute top-0 right-0 grid h-[60%] max-h-[100px] w-[30%] max-w-[300px] grid-rows-3 justify-items-end">
